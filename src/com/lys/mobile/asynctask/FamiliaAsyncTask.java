...
public class FamiliaAsyncTask extends AsyncTask<String,Integer,String> {
	...
	public  FamiliaAsyncTask (Context c) {
		super();
		context=c;
		...
		progressDialog.setMessage("Obteniendo Familia..");
	...
	public String doInBackground(String... params) {
		...
		String url= StringConexion.UrlServicesRest+"getFamilia";
		...
		String html="";
			...
			try {
			    ...
			    db.execSQL("DELETE FROM  MTP_FAMILIAINSPECCION");
		 ...
		 //	boton.setEnabled(true);
		    ...
		    if(result.equals("0")){
		    	...
		    	Log.d("cargo todo","detalles");
		   	  	...
		   	  	final InspeccionAsyncTask tarea=new InspeccionAsyncTask(context);   
		   	  	tarea.execute( new String[]{Util.url+"getInspeccion"});
...
public void agregarbd(Object[] o,  SQLiteDatabase db){
	...
	String fechaa=String.valueOf(o[5]);
	...
	db.execSQL("INSERT INTO MTP_FAMILIAINSPECCION(c_familiainspeccion,c_descripcion,n_tiempominimo, c_estado , d_ultimousuario,d_ultimafechamodificacion)"+
			   "VALUES ('" + o[0] + "', '" + o[1] + "','" + o[2] +"', '" + o[3] + "', '" + o[4] + "', '" + otroFormato.format(daten) + "')");
