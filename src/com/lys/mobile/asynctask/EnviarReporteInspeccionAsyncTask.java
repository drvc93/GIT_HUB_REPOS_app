...
public class EnviarReporteInspeccionAsyncTask extends AsyncTask<String,Integer,String>{
	...
	public EnviarReporteInspeccionAsyncTask (Context c,String corre,String cabecera,String compania,
			String user,String cmaquina,String condicion,String comentario,String estado,String periodo,
			String fechainicio,String fechafin, ArrayList<InspeccionData> detalle) {
		super();
		context=c;
		lista=detalle;
		corr=corre;
	...
	public String doInBackground(String... params) {
		...
		Log.i("TASK ==> ","Enviar reporte TASK");
		String url=params[0];
	...
	protected void onPostExecute(String result) {//paso 4
		...
		if(result.equals("")){
			...
			if(result.equals("0")){
		    	...
		    	final EnviarReporteDetalleInspeccionAsyncTask  enviarinspeccion=new 
		    		  EnviarReporteDetalleInspeccionAsyncTask (context,idca,corr,cabe,
		    		  Util.compania,use, cma,cond,comenta,"E",perio,fechainic,fechafi,lista);
