...
public class TipoRevisionGAsyncTask extends AsyncTask<String,Integer,String> {
	...
	public  TipoRevisionGAsyncTask (Context c) {
		super();
		context=c;
		...
		progressDialog.setMessage("Obteniendo Tipo Revision..");
	...
	public String doInBackground(String... params) {
		...
		String url= StringConexion.UrlServicesRest+"TipoRevisionG";
		...
		String html="";
			...
			try {
			    ...
			    db.execSQL("DELETE FROM MTP_TIPOREVISIONG");
		 ...
		 //	boton.setEnabled(true);
		    ...
		    if(result.equals("0")){
		    	...
		    	//boton.setEnabled(true);
		     	...
		     	Log.d("cargo todo","tiporevisiong");
		    	
			   	  	final TipoRevisionGParametroAsyncTask tarea=new TipoRevisionGParametroAsyncTask(context);   
			  	    tarea.execute( new String[]{Util.url+"TipoRevisionG_Parametro"});
...
public void agregarbd(Object[] o,SQLiteDatabase db){
	...
	db.execSQL("INSERT INTO MTP_TIPOREVISIONG(c_tiporevisiong,c_descripcion,c_estado) " +
			   "VALUES ('" + o[0] + "', '" + o[1] + "','" + o[2] + "')");
